...
// function to validate that people === number
...
// function to validate that the reservation != Tuesday
...
// function that makes sure the requested reservation.status === booked
